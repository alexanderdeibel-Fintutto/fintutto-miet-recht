...
// Demo-Daten für Beispiel-Dokumente
...
const neueFormulare = [
  { id: 'mietvertrag', label: 'Mietvertrag', href: '/formulare/mietvertrag', icon: FileSignature, farbe: 'blue' },
  { id: 'kuendigung', label: 'Kündigung', href: '/formulare/kuendigung', icon: FileText, farbe: 'red' },
  { id: 'uebergabeprotokoll', label: 'Übergabeprotokoll', href: '/formulare/uebergabeprotokoll', icon: ClipboardList, farbe: 'green' },
  { id: 'betriebskosten', label: 'Betriebskosten', href: '/formulare/betriebskosten', icon: Euro, farbe: 'emerald' },
  { id: 'mieterhoehung', label: 'Mieterhöhung', href: '/formulare/mieterhoehung', icon: TrendingUp, farbe: 'orange' },
  { id: 'maengelanzeige', label: 'Mängelanzeige', href: '/formulare/maengelanzeige', icon: AlertTriangle, farbe: 'amber' },
  { id: 'untermietvertrag', label: 'Untermietvertrag', href: '/formulare/untermietvertrag', icon: Key, farbe: 'purple' },
  { id: 'selbstauskunft', label: 'Selbstauskunft', href: '/formulare/selbstauskunft', icon: Users, farbe: 'cyan' },
]

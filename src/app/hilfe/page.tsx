...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    antwort: 'Bei jedem Formularfeld finden Sie ein Hilfssymbol mit einem Fragezeichen. Klicken Sie darauf, um kontextbezogene Erklärungen, rechtliche Hinweise mit Paragraphenangaben und Ausfüllvorschläge zu erhalten. Die KI hilft Ihnen, rechtssichere Formulierungen zu finden.',
    kategorie: 'ki'
  },
  {
  ...
  },
  {
    ...
    antwort: 'Im letzten Schritt jedes Formulars können Sie mit der Maus oder dem Finger (auf Touchgeräten) direkt im Unterschriftenfeld unterschreiben. Die Unterschrift wird als Bild im PDF eingebettet. Für rechtswirksame Verträge empfehlen wir zusätzlich eine handschriftliche Unterschrift.',
    kategorie: 'formulare'
  },
  {
    frage: 'Was ist die Kappungsgrenze bei Mieterhöhungen?',
    antwort: 'Die Miete darf innerhalb von 3 Jahren nicht um mehr als 20% steigen (§ 558 Abs. 3 BGB). In Gebieten mit angespanntem Wohnungsmarkt kann die Grenze auf 15% reduziert sein. Unser Mieterhöhungsformular prüft dies automatisch.',
    kategorie: 'rechtlich'
  },
  {
    frage: 'Welche Nebenkosten sind umlagefähig?',
    antwort: 'Die umlagefähigen Betriebskosten sind in der Betriebskostenverordnung (BetrKV) abschließend geregelt. Dazu gehören u.a. Grundsteuer, Wasser, Heizung, Müllabfuhr, Hausmeister, Gartenpflege und Aufzug. Verwaltungskosten und Reparaturen sind nicht umlagefähig.',
    kategorie: 'rechtlich'
  },
  {
    frage: 'Kann ich Formulare offline nutzen?',
    antwort: 'Die Web-Anwendung benötigt eine Internetverbindung für den ersten Zugriff. Einmal geladene Formulare können Sie jedoch auch bei schlechter Verbindung nutzen. Gespeicherte Dokumente bleiben lokal verfügbar.',
    kategorie: 'technisch'
  },
]
...
const kategorien = [
  ...
  { id: 'technisch', label: 'Technisches', icon: HelpCircle },
]
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {gefilterteFaqs.length} Fragen gefunden
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-2">
                  ...
                  <Card className="bg-muted/50">
                    <CardContent className="pt-4">
                      ...
                      <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
                        ...
                        <li>Sondervereinbarungen ergänzen</li>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-amber-800">
                    ...
                    <p className="mt-1">
                      ...
                      Rechtsberatung. Bei komplexen Sachverhalten oder Streitigkeiten empfehlen wir
                      die Beratung durch einen Fachanwalt für Mietrecht.
                    </p>
                  </div>
                </div>
              </CardContent>

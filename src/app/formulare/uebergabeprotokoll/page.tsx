...
// Step Components
import { Step1Grunddaten } from './steps/Step1Grunddaten'
import { Step2Zaehlerstaende } from './steps/Step2Zaehlerstaende'
import { Step3Schluessel } from './steps/Step3Schluessel'
import { Step4Raeume } from './steps/Step4Raeume'
import { Step5Vereinbarungen } from './steps/Step5Vereinbarungen'
import { Step6Unterschriften } from './steps/Step6Unterschriften'
...
const WIZARD_STEPS: WizardStep[] = [
  ...
  },
  {
    id: 'schluessel',
    title: 'Schlüssel',
    description: 'Schlüsselübergabe',
    icon: <Key className="h-5 w-5 text-primary" />
  },
  {
    id: 'raeume',
    title: 'Zustandserfassung',
    description: 'Raumweise Prüfung',
    icon: <ClipboardCheck className="h-5 w-5 text-primary" />
  },
  {
    id: 'vereinbarungen',
    title: 'Vereinbarungen',
    description: 'Mängel & Absprachen',
    icon: <Home className="h-5 w-5 text-primary" />
  },
  {
    id: 'unterschriften',
    title: 'Unterschriften',
    description: 'Protokoll abschließen',
...
const INITIAL_DATA: UebergabeprotokollData = {
  ...
  zaehlerstaende: [
    ...
    { ...EMPTY_ZAEHLERSTAND, zaehlerart: 'gas', einheit: 'm³' },
    { ...EMPTY_ZAEHLERSTAND, zaehlerart: 'wasser', einheit: 'm³' },
  ...
  raeume: [
    ...
    { ...EMPTY_RAUM, raumname: 'Küche', raumtyp: 'kueche' },

    ...
    <div className="space-y-8">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="p-4 bg-muted rounded-lg text-center">
              ...
              <p className="text-sm text-muted-foreground">Zähler abgelesen</p>
            </div>
            <div className="p-4 bg-muted rounded-lg text-center">
              <p className="text-2xl font-bold">
                {zusammenfassung.schluesselUebergeben}/{zusammenfassung.schluesselGesamt}
              </p>
              <p className="text-sm text-muted-foreground">Schlüssel übergeben</p>
            </div>
            <div className="p-4 bg-muted rounded-lg text-center">
              <p className="text-2xl font-bold">{zusammenfassung.raeumeGeprueft}</p>
              <p className="text-sm text-muted-foreground">Räume geprüft</p>
            </div>
            <div className="p-4 bg-muted rounded-lg text-center">
              ...
              <p className="text-sm text-muted-foreground">Räume mit Mängeln</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium">
                {data.reinigungszustand === 'gereinigt' ? 'Vollständig gereinigt' :
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-yellow-800">
                ...
                <ul className="list-disc list-inside text-yellow-600 mt-1">
                  {zusammenfassung.zaehlerAbgelesen < zusammenfassung.zaehlerGesamt && (
                    <li>
                      {zusammenfassung.zaehlerGesamt - zusammenfassung.zaehlerAbgelesen} Zählerstand(e) fehlen
                  ...
                  {zusammenfassung.schluesselUebergeben < zusammenfassung.schluesselGesamt && (
                    <li>
                      {zusammenfassung.schluesselGesamt - zusammenfassung.schluesselUebergeben} Schlüssel nicht übergeben
      ...
      <div className="space-y-6">
        ...
        <p className="text-sm text-muted-foreground">
          Mit der Unterschrift bestätigen alle Parteien die Richtigkeit der Angaben in diesem Protokoll.
        </p>

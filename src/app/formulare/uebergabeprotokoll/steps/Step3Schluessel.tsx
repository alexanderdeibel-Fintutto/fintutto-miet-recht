...
export function Step3Schluessel({ data, onChange }: Step3Props) {
  ...
  // Prüfen ob alle Schlüssel übergeben wurden
            ...
            <div>
              <p className={`font-medium ${allSchluesselUebergeben ? 'text-green-800' : 'text-yellow-800'}`}>
                {allSchluesselUebergeben
                  ...
                  : `${fehlendeSchluessel.length} Schlüsselart(en) unvollständig`
                }
              </p>
              {!allSchluesselUebergeben && (
                <p className="text-sm text-yellow-600">
                  Fehlende Schlüssel: {fehlendeSchluessel.map(s => s.art).join(', ')}
                </p>
              )}
            </div>
          </div>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-12 gap-4 text-sm font-medium text-muted-foreground pb-2 border-b">
              <div className="col-span-4">Schlüsselart</div>
              <div className="col-span-2 text-center">Vorhanden</div>
              <div className="col-span-2 text-center">Übergeben</div>
          ...
          >
            ...
            Weitere Schlüsselart hinzufügen
          </Button>
        </CardContent>
      </Card>
